...
namespace Kbg.NppPluginNET
{
    public static class Npp
    {
        ...
        public static ScintillaGateway Editor => new(PluginBase.GetCurrentScintilla());
        ...
        /// it can fail.
        /// </summary>
        public static string PluginDllDirectory { get; } = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);
        ...
        public static string CurrentEOL
        {
            ...
            {
                string eol = "\n";
                EndOfLine value = Editor.GetEOLMode();
