...
namespace NppPowerTools.Utils
{
    ...
    public class IniFile
    {
        ...
        /// <summary>
        /// Modifie ou crée une couleur d'une clé dans une section.
        /// Utilise soit le nom de la couleur (Blue, Red, ...) soit son code RGB en hexadecimal (#FFB0C2, #CCA0B3, ...)
        /// </summary>
        /// <param name="section">Nom de la section</param>
        /// <param name="key">Nom de la clef</param>
        /// <param name="colorValue">Couleur que l'on veut écrire</param>
        /// <param name="forceHexMode">Si <c>true</c> Force l'écriture au format hexadécimal (même si la couleur a un nom).</param>
        public void SetColor(string section, string key, Color colorValue, bool forceHexMode)
        {
            if (!forceHexMode && colorValue.IsNamedColor)
            {
                SetValue(section, key, colorValue.Name);
            }
            else
            {
                SetValue(section, key, ("#" + colorValue.R.ToString("x2") + colorValue.G.ToString("x2") + colorValue.B.ToString("x2")).ToUpper());
            }
        }
        ...
        /// <param name="key">Nom de la clef</param>
        /// <param name="colorValue">Couleur que l'on veut écrire</param>
        public void SetColor(string section, string key, Color colorValue)
        {
            SetColor(section, key, colorValue, false);
        }
        ...
        /// <summary>
        /// Retourne la valeur d'une clé sous forme d'une couleur.
        /// Gère les couleur par leur nom (Red, Blue, Yellow ...) ou par leur valeur RGB Hexa (#FFA9B8, #C0FFC0, ...).
        /// </summary>
        /// <param name="section">Nom de la section.</param>
        /// <param name="key">Nom de la clé.</param>
        /// <param name="defaut">Valeur par défaut si la clé recherchée n'existe pas.</param>
        /// <returns>Valeur du paramètre.</returns>
        public Color GetColor(string section, string key, Color defaut)
        {
            try
            {
                string sdefaut = "";
                ...
                if (res.StartsWith("#"))
                {
                    return System.Drawing.ColorTranslator.FromHtml(res);
                }
                else
                {
                    return Color.FromName(res);
                }
            }
            catch
            {
        ...
        {
            return GetColor(section, key, Color.White);
        }
        ...
        /// <param name="defaut">Valeur par défaut si la clé recherchée n'existe pas.</param>
        /// <returns>Valeur du paramètre.</returns>
        public Color GetColorWithoutCreating(string section, string key, Color defaut)
        {
            try
            {
                string sdefaut = "";
        ...
        /// <param name="key">Nom de la clé.</param>
        /// <returns>Valeur du paramètre.</returns>
        public Color GetColorWithoutCreating(string section, string key)
        {
            return GetColorWithoutCreating(section, key, Color.White);
        }

        /// <summary>
        /// Retourne la valeur d'une clé sous forme d'une couleur WPF.
        /// Gère les couleur par leur nom (Red, Blue, Yellow ...) ou par leur valeur RGB Hexa (#FFA9B8, #C0FFC0, ...).
        /// </summary>
        /// <param name="section">Nom de la section.</param>
        /// <param name="key">Nom de la clé.</param>
        /// <param name="defaut">Valeur par défaut si la clé recherchée n'existe pas.</param>
        /// <returns>Valeur du paramètre.</returns>
        public System.Windows.Media.Color GetWPFColor(string section, string key, System.Windows.Media.Color defaut)
        {
            try
            {
                string sdefaut = defaut.GetNameOrHexString();
        ...
        /// <param name="key">Nom de la clé.</param>
        /// <returns>Valeur du paramètre.</returns>
        public System.Windows.Media.Color GetWPFColor(string section, string key)
        {
            return GetWPFColor(section, key, System.Windows.Media.Colors.White);
        }
        ...
        /// <param name="defaut">Valeur par défaut si la clé recherchée n'existe pas.</param>
        /// <returns>Valeur du paramètre.</returns>
        public System.Windows.Media.Color GetWPFColorWithoutCreating(string section, string key, System.Windows.Media.Color defaut)
        {
            try
            {
                string sdefaut = defaut.GetNameOrHexString();
        ...
        /// <param name="key">Nom de la clé.</param>
        /// <returns>Valeur du paramètre.</returns>
        public System.Windows.Media.Color GetWPFColorWithoutCreating(string section, string key)
        {
            return GetWPFColorWithoutCreating(section, key, System.Windows.Media.Colors.White);
        }
        ...
        /// <param name="defaut">Valeur par défaut si la clé recherchée n'existe pas.</param>
        /// <returns>Valeur du paramètre.</returns>
        public Size GetSize(string section, string key, Size defaut)
        {
            try
            {
                string sdefaut = defaut.Width.ToString() + "," + defaut.Height.ToString();

                string res = GetValue(section, key, sdefaut);
                return new Size(int.Parse(res.Split(',')[0]), int.Parse(res.Split(',')[1]));
            }
            catch
            {
                return defaut;
        ...
        {
            return GetSize(section, key, new Size(1, 1));
        }
        ...
        /// <param name="defaut">Valeur par défaut si la clé recherchée n'existe pas.</param>
        /// <returns>Valeur du paramètre.</returns>
        public Size GetSizeWithoutCreating(string section, string key, Size defaut)
        {
            try
            {
                string sdefaut = defaut.Width.ToString() + "," + defaut.Height.ToString();
        ...
        /// <param name="key">Nom de la clé.</param>
        /// <returns>Valeur du paramètre.</returns>
        public Size GetSizeWithoutCreating(string section, string key)
        {
            return GetSizeWithoutCreating(section, key, new Size(1, 1));
        }
        ...
        /// <param name="defaut">Valeur par défaut si la clé recherchée n'existe pas.</param>
        /// <returns>Valeur du paramètre.</returns>
        public Point GetPoint(string section, string key, Point defaut)
        {
            try
            {
                string sdefaut = defaut.X.ToString() + "," + defaut.Y.ToString();

                string res = GetValue(section, key, sdefaut);
                return new Point(int.Parse(res.Split(',')[0]), int.Parse(res.Split(',')[1]));
            }
            catch
            {
                return defaut;
        ...
        {
            return GetPoint(section, key, new Point(0, 0));
        }
        ...
        /// <param name="defaut">Valeur par défaut si la clé recherchée n'existe pas.</param>
        /// <returns>Valeur du paramètre.</returns>
        public Point GetPointWithoutCreating(string section, string key, Point defaut)
        {
            try
            {
                string sdefaut = defaut.X.ToString() + "," + defaut.Y.ToString();
        ...
        /// <param name="key">Nom de la clé.</param>
        /// <returns>Valeur du paramètre.</returns>
        public Point GetPointWithoutCreating(string section, string key)
        {
            return GetPointWithoutCreating(section, key, new Point(0, 0));
        }
